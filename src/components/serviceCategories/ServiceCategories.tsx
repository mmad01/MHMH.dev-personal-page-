function ServiceCategories() {
  return (
    <div className="relative w-12/10 lg:w-auto">
      ...
      <div className="rounded-xl  border-1 border-[#282f3b]  h-[184px] flex items-center justify-between ">
        ...
        <div className=" w-full h-[104px] flex justify-end mr-2">
          <div className=" w-7/10 flex flex-col mr-10">
            <h1 className="text-[22px] lg:text-[40px] font-[Yekan-Bold] z-10 ">
              طراحی وب سایت
            </h1>
            <h2 className="opacity-50 text-[16px] lg:text-[24px] font-[Yekan-Fat] relative top-12">
              +80 پروژه
            </h2>
          </div>
          <img
