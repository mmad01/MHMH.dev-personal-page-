  ...
  return (
    <div className="mt-[160px] h-auto flex justify-center">
      <div className="flex items-end justify-between w-10/12 flex-col-reverse lg:flex-row lg:justify-between">
        <div className="flex justify-between text-right mt-20 relative right-36 w-10/12 md:right-0 md:w-1/1 lg:bottom-23 xl:bottom-0 lg:flex-col lg:justify-between lg:w-1.5/12 lg:mt-0">
