function PostsInPortfolioExam() {
  return (
    <div className="bg-[#101B2E] w-[160px] md:w-[200px] lg:w-[250px] xl:w-[200px] 2xl:w-[260px] h-[184px] md:h-[234px] lg:h-[284px] rounded-xl flex flex-col mb-20 mr-20 cursor-pointer hover:bg-[#222f43] active:bg-[#192538]">
      ...
      <div className=" w-full h-20  mt-3 font-[Yekan-Fat] flex flex-col justify-center items-end">
        <h1 className="text-[13px] md:text-[17px] lg:text-[22px] xl:text-end text-white mr-5">
